...
$Ure = new ADM();
//To check if the user has clicked on the POST button
//Collect the data from the $_POST variable (userdata)
...
<div class=logo>
 ...
 <br><br>
      ...
      <button type="submit" name="SIGNUP"><strong>SIGNUP</strong></button> <br> <br>
